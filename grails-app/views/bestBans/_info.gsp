        ...
        <div id="collapseSeven" class="panel-collapse collapse" role="tabpanel" aria-labelledby="headingSeven">
            <div class="panel-body">
                <p>
                    ...
                    <br/><br/>
                    For the latest information about the site, follow us on twitter at <a href="https://twitter.com/BestBans">twitter.com/BestBans</a>
                </p>
            </div>
        </div>
    </div>
...
<br/>
<p>
    If you enjoy our site, any support is greatly appreciated!
</p>
<form action="https://www.paypal.com/cgi-bin/webscr" method="post" target="_top">
    <input type="hidden" name="cmd" value="_s-xclick">
    <input type="hidden" name="hosted_button_id" value="Z5796Q4N2GCKC">
