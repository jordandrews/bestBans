...
<div style="text-align: center"><g:img  file="champIcons/ChampionSplashes/${champData.champion}splash.png" title="${champData.displayName}" alt="${champData.champion}"  width="${Math.ceil(117*(1-(0.1*Math.floor((tempRank-1)/4))))}" height="${Math.ceil(212*(1-(0.12*Math.floor((tempRank-1)/4))))}"/></div>
<div class="row">
